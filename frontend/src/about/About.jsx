...
function About() {
  return (
    <>
      <Navbar />
      <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0 dark:bg-slate-900 dark:text-white">
        <div className="absolute inset-0 -z-10 overflow-hidden dark:bg-slate-900 dark:text-white">
          <svg
